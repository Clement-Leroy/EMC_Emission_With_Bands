...
def axes_param (relayoutData, x_min, x_max, y_min, y_max, figure, log):
    triggered_id = ctx.triggered_id
    print(list(relayoutData.keys())[0])
    if relayoutData and 'annotations' not in list(relayoutData.keys())[0] or triggered_id == 'input_x_min-emission_h' or triggered_id == 'input_x_max-emission_h' or triggered_id == 'input_y_min-emission_h' or triggered_id == 'input_y_max-emission_h' or triggered_id == 'input_x_min-emission_v' or triggered_id == 'input_x_max-emission_v' or triggered_id == 'input_y_min-emission_v' or triggered_id == 'input_y_max-emission_v' or triggered_id == 'input_x_min-emission_ground' or triggered_id == 'input_x_max-emission_ground' or triggered_id == 'input_y_min-emission_ground' or triggered_id == 'input_y_max-emission_ground' or triggered_id == 'input_x_min-emission_supply' or triggered_id == 'input_x_max-emission_supply' or triggered_id == 'input_y_min-emission_supply' or triggered_id == 'input_y_max-emission_supply':
