...
@app.callback(Output('emission_radiated_horizontal', 'figure',allow_duplicate = True),
    Output('emission_radiated_vertical', 'figure',allow_duplicate = True),
    Output('emission_radiated_horizontal', 'relayoutData'),
    Output('emission_radiated_vertical', 'relayoutData'),
...
def emission_charts(data, suspectsTable, selectedRows, figure_horizontal, figure_vertical, style_horizontal, style_vertical, loading_emission_horizontal, loading_emission_vertical, log_h, log_v, colors, cursor_options_h, cursor_value_h, cursor_options_v, cursor_value_v, emission_tab, test_tab, cursor_output, limit, Div_axes_param_h, Div_axes_param_v, markers_h, markers_v, rowData_tests, rowData_limit_h, rowData_line_h, rowData_limit_v, rowData_line_v, line_param_h, btn_txt_h, line_param_v, btn_txt_v, cursor_data, activate_cursors_horizontal, activate_cursors_vertical):
    ...
    if data != []:
        ...
        options = []
        cursor_output = f'ΔFrequency (MHz) = - \n ΔLevel (dBμV/m) = -'
        if activate_cursors_horizontal == False:
            activate_cursors_horizontal = no_update
        if activate_cursors_vertical == False:
            activate_cursors_vertical = no_update
    ...
    return figure_horizontal, figure_vertical, {'autosize': True}, {'autosize': True}, style_horizontal, style_vertical, loading_emission_horizontal, loading_emission_vertical, cursor_options_h, cursor_value_h, cursor_options_v, cursor_value_v, activate_cursors_horizontal, activate_cursors_vertical, cursor_data, emission_tab, test_tab, markers_h, markers_v, cursor_output, cursor_output, Div_axes_param_h, Div_axes_param_v, rowData_limit_h, rowData_line_h, rowData_limit_v, rowData_line_v, selectedRows_h, selectedRows_v, line_param_h, btn_txt_h, line_param_v, btn_txt_v, radiated_btn
...
def ground_axes_param (relayoutData, restyleData, n_blur_x_min, n_blur_x_max, n_blur_y_min, n_blur_y_max, n_submit_x_min, n_submit_x_max, n_submit_y_min, n_submit_y_max, x_min, x_max, y_min, y_max, figure, log):
    if figure['data'] != []:
...
def supply_axes_param (relayoutData, restyleData,n_blur_x_min, n_blur_x_max, n_blur_y_min, n_blur_y_max, n_submit_x_min, n_submit_x_max, n_submit_y_min, n_submit_y_max, x_min, x_max, y_min, y_max, figure, log):
    if figure['data'] != []:
        return axes_param(relayoutData, x_min, x_max, y_min, y_max, figure, log)
    else:
        raise PreventUpdate
...
def horizontal_axes_param (relayoutData, restyleData, n_blur_x_min, n_blur_x_max, n_blur_y_min, n_blur_y_max, n_submit_x_min, n_submit_x_max, n_submit_y_min, n_submit_y_max, x_min, x_max, y_min, y_max, figure, log):
    if figure['data'] != []:
        return axes_param(relayoutData, x_min, x_max, y_min, y_max, figure, log)
    else:
        raise PreventUpdate
...
def vertical_axes_param (relayoutData, restyleData, n_blur_x_min, n_blur_x_max, n_blur_y_min, n_blur_y_max, n_submit_x_min, n_submit_x_max, n_submit_y_min, n_submit_y_max, x_min, x_max, y_min, y_max, figure, log):
    if figure['data'] != []:
        return axes_param(relayoutData, x_min, x_max, y_min, y_max, figure, log)
    else:
        raise PreventUpdate
...
def axes_param (relayoutData, x_min, x_max, y_min, y_max, figure, log):
    triggered_id = ctx.triggered_id
    print(triggered_id)
    if triggered_id == 'emission_conducted_ground' or  triggered_id == 'emission_conducted_supply' or triggered_id == 'emission_radiated_horizontal' or  triggered_id == 'emission_radiated_vertical' or triggered_id == 'input_x_min-emission_h' or triggered_id == 'input_x_max-emission_h' or triggered_id == 'input_y_min-emission_h' or triggered_id == 'input_y_max-emission_h' or triggered_id == 'input_x_min-emission_v' or triggered_id == 'input_x_max-emission_v' or triggered_id == 'input_y_min-emission_v' or triggered_id == 'input_y_max-emission_v' or triggered_id == 'input_x_min-emission_ground' or triggered_id == 'input_x_max-emission_ground' or triggered_id == 'input_y_min-emission_ground' or triggered_id == 'input_y_max-emission_ground' or triggered_id == 'input_x_min-emission_supply' or triggered_id == 'input_x_max-emission_supply' or triggered_id == 'input_y_min-emission_supply' or triggered_id == 'input_y_max-emission_supply' or relayoutData and 'annotations' not in list(relayoutData.keys())[0]:
        ...
        elif triggered_id == 'emission_conducted_ground' or  triggered_id == 'emission_conducted_supply' or triggered_id == 'emission_radiated_horizontal' or  triggered_id == 'emission_radiated_vertical':
            print('get_axes_range(figure, log, relayoutData)')
...
def toggle_marker_radiated (on, figure_radiated_horizontal, figure_radiated_vertical, markers_h, markers_v):
    return toggle_marker(on, figure_radiated_horizontal, figure_radiated_vertical, markers_h, markers_v)
